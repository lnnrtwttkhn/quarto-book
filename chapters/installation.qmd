...
Quarto is free to use and available for download on [Quarto's website](quarto.org).
...
Go to the directory in which Quarto is downloaded and double-click on it to start the installation process. During the installation process, you'll be presented with various options and settings.
