...
## What do different Creative Commons {{< fa brands creative-commons >}} licenses mean?
...
The reuser is obligated to give credit to the original work and is then allowed to reuse, distribute, modify, and develop it further.
The right to commercial use is also granted under this type of license.
The reuser indicates that the material follows the CC BY license by adding this statement:

{{< fa brands creative-commons-by >}} BY: Credit must be given to the creator.

### CC BY-SA {{< fa brands creative-commons-by >}} {{< fa brands creative-commons-sa >}}
The reuser is obligated to give credit to the original work and is then allowed to reuse, distribute, modify, and develop it further.
The right to commercial use is also granted under this type of license.
If the work is redistributed, further developed, or modified, the reuser must license the new work under the same terms.
The reuser indicates that the material follows the CC BY-SA license by adding this statement:

{{< fa brands creative-commons-by >}} BY: Credit must be given to the creator.
{{< fa brands creative-commons-sa >}} SA: Adaptations must be shared under the same terms.


### CC BY-NC {{< fa brands creative-commons-by >}} {{< fa brands creative-commons-nc >}}
The reuser is obligated to give credit to the original work and is then allowed to reuse, distribute, modify, and develop it further.
The right to commercial use is *not* granted under this type of license.
The reuser indicates that the material follows the CC BY license by adding this statement:
{{< fa brands creative-commons-by >}} BY: Credit must be given to the creator.
{{< fa brands creative-commons-nc >}} NC: Only noncommercial uses of the work are permitted.
...
The reuser is obligated to give credit to the original work, but is not allowed to readapt it.
The right to commercial use is also granted under this type of license.
The reuser indicates that the material follows the CC BY license by adding this statement:
{{< fa brands creative-commons-by >}} BY: Credit must be given to the creator.
{{< fa brands creative-commons-nd >}} ND: No derivatives or adaptations of the work are permitted.
