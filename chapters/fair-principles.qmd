...
Since science has transitioned from pens and paper to keyboards and monitors, developing a suitable and appropriate approach to archiving, reproducing, sharing, and collaborating on scientific outputs seems inevitable.
One of the most well-known frameworks developed by @wilkinson2016 to define best practices in research data management is the **FAIR** principles. FAIR stands for ***Findable***, ***Accessible***, ***Interoperable***, and ***Reusable***.
The FAIR principles serve as a guide to achieving better data management.
They enable data to be ***machine actionable***, meaning they equip autonomous computational systems with detailed, structured information while exploring the data.
...
PIDs guarantee that the link won't be rotten and will always be accessible.
There are services that provide PIDs.
For example, Open Researcher and Contributor ID (ORCID) and Zenodo (see the chapter on Zenodo) provide free PIDs.
Using PIDs and registering your work with these service providers contributes to greater recognition of your materials as well.
...
A good example of rich metadata description is used on
A general platform for online registration of the materials is the [Open Educational Resources Initiative](https://asccc-oeri.org/).
Based on the audience of the materials, there are online platforms that host specific materials.
Online registration via tools like TeSS (Training eSupport System), which is focused on life sciences
In psychology, it is possible to register your work on Society for the Teaching of Psychology [STP]({{< var links.STP >}}).
...
Although we promote the openness of teaching materials, there may be situations in which one doesn't want to share the materials openly.
For example, the materials may be crafted specifically for a particular institution, or only certain members of a university may access the materials.
In these cases, it is important to clearly state the access levels and how one can request access to the materials.
This description should contain information about whether the materials are free or paid, or if there is a way to authenticate access to the materials.
It is also necessary to clarify accessibility in the metadata, even if the material is openly accessible to everyone and shared on the web.
...
Most university lectures and seminars are accompanied by a series of slides, scripts, research papers and other types of digital contents.
Interoperibility makes sure that one content can be used and developed in another context than its original one.
...
To remedy the aforementioned issues, one can use LaTeX typesetting system or markdown tools.
...
However, we should not forget that these formats have their own weaknesses such as having a relatively steep learning curve and doing their best when online which maybe limiting.
...
In short, licenses let others know to what extent they are allowed to (re)use, modify, take inspirations from your work.
Universities and other institutions may have their own regulations for the materials developed by their affiliates.
This may limit the reach of your materials but stating and sticking to it is necessary.
The most used license for free and open access materials is the Creative Common (CC) license.
...
Contribution is a mean of improving the materials.
Others may offer new perspectives, find issues, suggest recommendation for enhancement, etc.
Using a CONTRIBUTION file, you can clearly guide users to contribute to your work and define how they should contribute.
...
You have to keep track of the changes in your materials throughout the time.
...
Also, tools like Quarto and Git make it easy to update the materials and share it across different platforms.
...
We rely on two tools that we think are fundamental for making such educational materials, namely Git and Quarto, which relatively guaranteed the FAIRness of the materials, if used properly.
As this guide focuses on Quarto, [The Version Control Book](https://lennartwittkuhn.com/version-control-book) written by [Lennart Wittkuhn](https://lennartwittkuhn.com) and Konrad Pagenstedt (2024) on Git, which is recommended reading, as Quarto and Git can be extremely powerful tools when used together.
